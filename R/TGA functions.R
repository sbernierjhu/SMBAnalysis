...
#'
#'This function loads into memory the header of a binary file generated by a TA SDT Q600 TGA-DSC. These files typically end in .001, .002, or similar. It may be applicable to other binary files with a header followed by numeric data, but this is untested. The "\f" character is used to detect the end of the header and start of the data.
#'
...
#'
#'This function loads into memory the header of a text file generated by TA Universal Analysis based on binary file from a TA SDT Q600 TGA-DSC. These files end in .txt but their contents may vary depending on what the Universal Analysis user selected during export. The "StartOfData" phrase is used to detect the end of the header and start of the data.
#'
#' @param filename String name of the file to open. If the file is not stored in your current working directory, be sure to include the full path to the file.
#' @returns String vector containing all the header info.
