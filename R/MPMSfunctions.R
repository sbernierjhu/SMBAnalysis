...
OpenMPMSData <- function(folder=getwd(),filename=NULL,removenames=c("Action","Range","Min","Max","Pressure","Number","code","Motor","Stat","Averag","Scan","Chamber","Drift","Position","Fit","Phase","ACX","Cycles","Type","Trim","Signal"),preserveempty=FALSE,relativetime=FALSE){
  if(is.null(filename))
